...
//        receiveChallenge()
         ...
         task = Alamofire.request(urlString, method:  HTTPMethod(rawValue: method.rawValue) ?? .get, parameters: parameter, encoding: URLEncoding.default, headers: header)
...
//        receiveChallenge()
        ...
        Alamofire.request(urlString, method:  HTTPMethod(rawValue: method.rawValue) ?? .get, parameters: parameter, encoding: URLEncoding.default, headers: header)
            .responseData { (responseData) in
                response(responseData.data, responseData.response, responseData.error)
        }
    }
